...
1. Build dependency graph for current phase:
...
1. Select relevant summaries (typically 2-4 prior phases)

2. Extract context from frontmatter:
...
1. Read FULL summaries only for selected relevant phases.
