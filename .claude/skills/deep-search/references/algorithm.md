...
**Example Seed Email:**
```bash
From: Salvador Beltran <[sbeltran@sdbeng.com](mailto:sbeltran@sdbeng.com)>
To: Chi <[chi@desertservices.net](mailto:chi@desertservices.net)>
...
|------|-------|------------|
| person | [sbeltran@sdbeng.com](mailto:sbeltran@sdbeng.com) | 0.95 |
| person | [chi@desertservices.net](mailto:chi@desertservices.net) | 0.95 |
...
Query 3: "[sbeltran@sdbeng.com](mailto:sbeltran@sdbeng.com)"
...
```bash
Search 1: [chi@desertservices.net](mailto:chi@desertservices.net) for "Cradle to Crayons"
  → 2 results

Search 2: [chi@desertservices.net](mailto:chi@desertservices.net) for "Valley Rain Construction"
  → 5 results (includes other projects)

Search 3: [jared@desertservices.net](mailto:jared@desertservices.net) for "Cradle to Crayons"
  → 0 results (no estimate sent)

Search 4: [chi@desertservices.net](mailto:chi@desertservices.net) for "SDB"
...
From Valley Rain results:
  ...
  - New person: [kendra@valleyrainaz.com](mailto:kendra@valleyrainaz.com)
...
Search 6: "[kendra@valleyrainaz.com](mailto:kendra@valleyrainaz.com)"
...
const attachments = await mcp__desert-email__get_attachments({
  messageId: "AAMk...",
  userId: "[chi@desertservices.net](mailto:chi@desertservices.net)"
});
...
- Chi (c[hi@desertservices.net](mailto:hi@desertservices.net)) - Project Coordinator, primary contact
- Jared (j[ared@desertservices.net](mailto:ared@desertservices.net)) - Estimator

**Client Side:**
- Kendra (k[endra@valleyrainaz.com](mailto:endra@valleyrainaz.com)) - Valley Rain, issues POs
- Salvador Beltran (s[beltran@sdbeng.com](mailto:beltran@sdbeng.com)) - SDB Engineering, requests quotes
