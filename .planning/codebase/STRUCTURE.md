...
│   ├── server.ts              # Bun server entry point with routing
...
│   │   ├── monday.ts
│   │   └── webhooks.ts
│   └── frontend/              # React SPA (bundled as single app)
...
│           ├── quotes.tsx     # Quotes list (GET /api/quotes)
│           ├── quote-editor.tsx # Quote editor (GET /api/quotes/:id)
│           ├── takeoffs.tsx   # Takeoffs list
│           ├── takeoff-editor.tsx # Takeoff PDF viewer & annotator
│           ├── catalog.tsx    # Service catalog manager
...
│   ├── pdf/                   # PDF generation
│   │   ├── pdf-builder.ts     # pdfmake document definitions
│   │   ├── generate-pdf.ts    # PDF generation functions
│   │   └── generate-client.ts
...
│   │   ├── manual-inputs.ts
│   │   └── ...
│   ├── types.ts               # TypeScript interfaces (Quote, Takeoff, etc.)
│   ├── utils.ts               # Utilities (cn, formatCurrency, formatDate, etc.)
│   ├── takeoffs.ts            # Takeoff API helpers
│   ├── minio.ts               # MinIO client (file storage)
│   └── monday-search.ts       # Monday.com search utilities
├── services/                  # External service integrations
│   ├── email/                 # Microsoft Graph email
│   ├── monday/                # Monday.com API client
│   ├── notion/                # Notion API client
│   ├── contract/              # Contract management
│   ├── quoting/               # Quoting logic
...
├── docs/                      # Documentation
├── scripts/                   # Utility scripts (one-offs, data migrations)
├── .planning/                 # GSD planning documents
│   └── codebase/              # This directory
├── package.json               # Bun dependencies
├── tsconfig.json              # TypeScript configuration
├── biome.jsonc                # Ultracite/Biome linting config
