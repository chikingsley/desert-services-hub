...
export const FORMS = {
  ...
  complaints: {
    ...
    fields: {
      facilityId: "_idJsp6:_idJsp20",
      facilityName: "_idJsp6:_idJsp21",
      companyName: "_idJsp6:cmpName",
      complaintId: "_idJsp6:_idJsp26",
      category: "_idJsp6:complaintCategory",
      subcategory: "_idJsp6:complaintSubcategory",
      inspectionZone: "_idJsp6:inspectionZoneCd",
      dateField: "_idJsp6:dateField",
      dateFrom: "_idJsp6:From",
      dateTo: "_idJsp6:To",
    },
  ...
  invoices: {
    ...
    fields: {
      ...
      companyName: "_idJsp6:cmpName",
      invoiceNumber: "_idJsp6:_idJsp27",
      invoiceStatus: "_idJsp6:_idJsp28",
      invoiceType: "_idJsp6:_idJsp30",
      transactionId: "_idJsp6:_idJsp34",
      referenceNumber: "_idJsp6:_idJsp35",
    },
  },
  inspections: {
    formName: "_idJsp5",
  ...
  siteVisits: {
    ...
    fields: {
      ...
      facilityType: "_idJsp6:_idJsp25",
      siteVisitId: "_idJsp6:_idJsp31",
      visitType: "_idJsp6:visitTypeChoice",
      complianceIssue: "_idJsp6:_idJsp33",
      associatedInspectionId: "_idJsp6:_idJsp35",
      companyName: "_idJsp6:cmpName",
