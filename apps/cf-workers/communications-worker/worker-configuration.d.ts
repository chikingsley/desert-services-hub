/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9de36799bceccc19d6ae05e23e421992)
...
declare namespace Cloudflare {
	...
	interface Env {
		MAILBOX_EVENTS_QUEUE: Queue;
		COMMUNICATIONS_APP_BASE_URL: string;
		AZURE_TENANT_ID: string;
		AZURE_CLIENT_ID: string;
		AZURE_CLIENT_SECRET: string;
		SUBMITTED_BILLING_WORKFLOW: Workflow<Parameters<import("./src/index").SubmittedBillingWorkflow['run']>[0]['payload']>;
		SUBMITTED_CLIENT_WORKFLOW: Workflow<Parameters<import("./src/index").SubmittedClientWorkflow['run']>[0]['payload']>;
		ISSUED_CLIENT_WORKFLOW: Workflow<Parameters<import("./src/index").IssuedClientWorkflow['run']>[0]['payload']>;
	}
}
