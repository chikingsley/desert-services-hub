 ...
 *
 * Usage:
 *   bun apps/cli-tools/email-cli/bin/cli.ts <command> [options]
 *
...
Usage: bun apps/cli-tools/email-cli/bin/cli.ts <command> [options]
...
Examples:
  ...
  bun apps/cli-tools/email-cli/bin/cli.ts contracts "Layton"           # Search contracts mailbox
  bun apps/cli-tools/email-cli/bin/cli.ts estimating "bid"             # Search estimating mailbox
  bun apps/cli-tools/email-cli/bin/cli.ts ic                           # List InternalContracts group
  bun apps/cli-tools/email-cli/bin/cli.ts ic "Helen"                   # Search InternalContracts group
  bun apps/cli-tools/email-cli/bin/cli.ts search-group dust-control "permit"

  # Create drafts:
  bun apps/cli-tools/email-cli/bin/cli.ts draft --subject "Hello" --body "Hi there" --to "user@example.com"
  bun apps/cli-tools/email-cli/bin/cli.ts reply-draft "invoice" --body "Thanks for the invoice" --reply-all
  bun apps/cli-tools/email-cli/bin/cli.ts send-draft <draftId>         # Send an existing draft

  # Send dust permit email using template:
  bun apps/cli-tools/email-cli/bin/cli.ts send-template dust-permit-issued \\
