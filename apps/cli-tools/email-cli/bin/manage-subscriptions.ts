 ...
 *
 * Usage:
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts create --all
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts create --mailbox=chi@desertservices.net
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts list
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts renew
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts delete --all
 *   bun apps/cli-tools/email-cli/bin/manage-subscriptions.ts status
 */
import {
