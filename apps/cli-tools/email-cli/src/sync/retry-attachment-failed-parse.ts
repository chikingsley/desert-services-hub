 ...
 *
 * Usage:
 *   bun apps/cli-tools/email-cli/src/sync/retry-attachment-failed-parse.ts
 *   bun apps/cli-tools/email-cli/src/sync/retry-attachment-failed-parse.ts --mailbox denise@desertservices.net
 *   bun apps/cli-tools/email-cli/src/sync/retry-attachment-failed-parse.ts --dry-run
 *   bun apps/cli-tools/email-cli/src/sync/retry-attachment-failed-parse.ts --match "custom error text"
 */
