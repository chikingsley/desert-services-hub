...
export const BOARD_IDS = {
  ...
  // ============================================================================
  // PROCUREMENT WORKSPACE (8240372) - Archived
  // ============================================================================
  // These boards are no longer active. Data extracted to scripts/procurement.db
  // See scripts/PROCUREMENT-README.md for details.
  OPEN_BIDS: "7505227263", // 1. Open Bids
  BIDS_SENT: "7505653112", // 2. Bids Sent
  CHECKLIST: "7844326622", // 3. Checklist
  DUST_PERMITS_WM: "7816215167", // 4.a. Dust Permits (old)
 ...
 *
 * Note: CONTRACTOR is a mirror column that reflects the linked contractor name.
 * Use CONTRACTORS_DIRECT for the actual board_relation link.
 */
export const ESTIMATING_COLUMNS = {
  ...
  // Direct board relations (preferred over legacy CONTACTS mirror)
  ...
  // Legacy: ACCOUNTS was renamed to CONTRACTORS_DIRECT - keep alias for compatibility
  ...
  // Legacy contact relations (use CONTACTS_DIRECT for the direct link)
...
export const CONTACTS_COLUMNS = {
  ...
  // Metadata columns for import tracking
...
/** A file asset attached to a Monday item */
