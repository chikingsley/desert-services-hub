 ...
 *
 * Usage:
 *   bun apps/cli-tools/sharepoint-cli/bin/walk.ts <path-or-preset> [options]
 *
 * Presets:
 ...
 *
 * Examples:
 *   bun apps/cli-tools/sharepoint-cli/bin/walk.ts inspections
 *   bun apps/cli-tools/sharepoint-cli/bin/walk.ts "Customer Projects/Active" --depth=2
 *   bun apps/cli-tools/sharepoint-cli/bin/walk.ts inspections --json
 *   bun apps/cli-tools/sharepoint-cli/bin/walk.ts "SWPPP/INSPECTIONS/PROJECTS/PROJECTS A-M/ARCO" --depth=3
 */
...
Usage: bun apps/cli-tools/sharepoint-cli/bin/walk.ts <path-or-preset> [options]
