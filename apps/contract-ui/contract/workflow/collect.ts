...
import { createClient, type GraphEmailClient } from "@services/email";
import {
  type Attachment,
  type ContractEmail,
  getContractEmails,
...
Document Collection Commands:
  ...
  bun apps/contract-ui/contract/workflow/collect.ts collect <subject>
    Collect PDFs for a contract thread

  bun apps/contract-ui/contract/workflow/collect.ts add <folder> <path>
    Add a local PDF to a project folder

  bun apps/contract-ui/contract/workflow/collect.ts list <folder>
