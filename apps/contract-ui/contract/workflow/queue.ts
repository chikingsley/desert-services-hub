...
Contract Queue Commands:
  ...
  bun apps/contract-ui/contract/workflow/queue.ts list
    List all contracts in the queue

  bun apps/contract-ui/contract/workflow/queue.ts pending
    List only pending (unprocessed) contracts

  bun apps/contract-ui/contract/workflow/queue.ts with-attachments
    List contracts that have attachments

  bun apps/contract-ui/contract/workflow/queue.ts search <query>
    Search contracts by keyword

  bun apps/contract-ui/contract/workflow/queue.ts details <subject>
