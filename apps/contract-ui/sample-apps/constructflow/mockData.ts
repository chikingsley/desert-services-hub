...
export const MOCK_ATTACHMENTS: Attachment[] = [
  {
    id: "a1",
    name: "PCSD_Music_Bldg_Plans.pdf",
    size: "4.2 MB",
  ...
  {
    id: "a2",
    name: "Dust_Permit_Application_220668.pdf",
    size: "1.1 MB",
    type: "application/pdf",
    url: "#",
    category: "Permit",
  ...
  {
    id: "a3",
    name: "Bellmont_Contract_V2.docx",
    size: "850 KB",
  ...
  {
    id: "a6",
    name: "Zoning_Approval_Maricopa.pdf",
    size: "1.8 MB",
    type: "application/pdf",
    url: "#",
    category: "Permit",
...
export const MOCK_TASKS: Task[] = [
  {
    id: "t1",
    title: "File Dust Permit Application",
    status: "Pending",
    dueDate: "Feb 5, 2026",
    assignee: "Chi E.",
  },
  {
    id: "t2",
    title: "Validate Vendor Insurance",
    status: "Done",
    dueDate: "Jan 27, 2026",
    assignee: "System",
  },
  ...
  {
    id: "t4",
    title: "Review Blueprint Revisions",
    status: "Pending",
    dueDate: "Feb 10, 2026",
    assignee: "Chi E.",
  },
  {
    id: "t5",
    title: "Finalize Subcontractor List",
    status: "Done",
    dueDate: "Jan 25, 2026",
    assignee: "Michael R.",
  },
...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    progress: 45,
    description:
      "Expansion of the Resident Gathering Space (RGS) including interior remodeling and outdoor landscaping.",
  },
  {
    id: "p2",
    ...
    progress: 30,
    description:
      "New billing facility infrastructure setup for Greenway corporate office.",
  },
  {
    id: "p3",
    ...
    progress: 15,
    description:
      "Grading and sitework for a 500,000 sq ft logistics warehouse.",
  },
];
...
export const MOCK_EMAILS: Email[] = [
  {
    ...
    isRead: false,
    aiSummary:
      "PO intake for Sun Health La Loma project. Matches Estimate #EST-2026-001.",
  },
  {
    id: "e2",
    sender: "Chi Ejimofor",
  ...
  },
  {
    ...
    isRead: false,
    aiSummary:
      'Unmatched permit found. High probability it belongs to "McDowell Project" estimate #EST-2026-088.',
  },
  {
    id: "e5",
