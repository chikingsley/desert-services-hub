          ...
          <div>
            ...
            {focusedTaskID &&
              project.tasks.find((t) => t.id === focusedTaskID)
                ?.primaryAction && (
                <div className="mt-2 flex animate-pulse items-center gap-1.5 font-black text-[10px] text-indigo-600 uppercase tracking-widest">
            ...
            >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className="flex h-5 items-center gap-0.5 rounded border border-slate-300 border-dashed px-1.5 text-slate-400 transition-colors hover:border-indigo-400 hover:text-indigo-500"
                    onClick={(e) => e.stopPropagation()}
                    type="button"
                  >
