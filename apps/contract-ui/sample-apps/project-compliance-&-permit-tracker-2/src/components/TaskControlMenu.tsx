        ...
        <div className="p-4">
          <TabsContent className="mt-0 space-y-4" value="status">
            <div className="space-y-1.5">
              <Label className="border-none font-black text-[10px] text-slate-400 uppercase tracking-tighter">
                ...
                <div className="flex flex-col gap-1.5">
                  {[
                    ...
                    >
                      <div
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-full border text-[8px]",
                          task.status === s.val
