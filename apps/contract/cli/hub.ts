...
import { syncContacts } from "@contract/cli/sync/contacts";
import { syncContractors } from "@contract/cli/sync/contractors";
import { syncEstimates } from "@contract/cli/sync/estimates";
import { showStats } from "@contract/cli/sync/stats";
 ...
 * SQLite will wait up to 5 seconds for a lock instead of immediately failing.
 */
