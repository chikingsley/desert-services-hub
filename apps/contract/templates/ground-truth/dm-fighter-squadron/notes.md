# DM 47th Fighter Squadron (22-014) - Ground Truth Notes
...
Project Name: 47th Fighter Squadron Project / Bldg 5247
Location: Davis-Monthan AFB, Tucson, AZ
GC: Richard Group (Chicago, IL)
End User: USACE (US Army Corps of Engineers)
...
SUSPENDED since November 27, 2024

Original completion: September 4, 2024 (will be significantly extended)
Planned resumption: End of February 2026
New completion: No earlier than July 2027, potentially through end of 2027

Mission Change: Originally A-10 operations center, now OA-1K Skyraider II (requires revised building layout)

---

## Suspension History

- July 2023: Delays started
- November 27, 2024: Formally suspended
- November 2024: $10,000 change order approved to continue services indefinitely during suspension
- January 23, 2026: Resumption of work notice issued

---

## Cost Escalation Request

Richard Group requesting cost escalation documentation by February 13, 2026.
...
- Cost escalation
- Warehouse and CONEX storage rental
- Re-inspections of work already in place
- Reworking of work already put in place, as deemed necessary

All requests must include:

- Original quotes vs updated quotes
- Detailed documentation
- Unsupported values will be denied per Government standards

---

## Desert Services Scope

We have been providing SWPPP inspections. CORs (Change Order Requests) submitted through GC Pay.

November 2024: $10,000 change order approved in GCPay to continue services during suspension.

**Change Order Status (RESOLVED):** The $10k COR was created in GCPay to add contract capacity but no work was actually billed against it. A credit memo was applied on 6/5/25 to remove it. Per Kendra (Sept 2025): "It was just a COR sent to get money added to the contract so it was not billing for anything, just needed to get rid of it."

---

## Original Estimate Breakdown (Sept 2022)

Est_09202211_DESERT_SERVICES_1788.pdf - Total: **$17,552.00**

| Item | Qty | Unit | 2022 Price | Extended |
|------|-----|------|------------|----------|
| SWPPP Narrative | 1 | EA | $1,095.00 | $1,095.00 |
| Silt Fence (Install & Remove) | 450 | LF | $4.90 | $2,205.00 |
| Compost Filter Sock (Install) | 150 | LF | $2.75 | $412.50 |
| Compost Filter Sock (Remove) | 150 | LF | $1.00 | $150.00 |
| Inlet Protection (Install & Remove) | 10 | EA | $125.00 | $1,250.00 |
| SWPPP Sign | 1 | EA | $275.00 | $275.00 |
| Spill Kit | 1 | EA | $325.00 | $325.00 |
| SWPPP Inspections | 34 | EA | $295.00 | $10,030.00 |
| Mobilization | 1 | EA | $450.00 | $450.00 |
| NOI (MC Dust Control Permit) | 1 | EA | $1,150.00 | $1,150.00 |
| NOT (MC Dust Control Permit) | 1 | EA | $210.00 | $210.00 |

---

## 2022 vs 2026 Price Comparison

| Item | 2022 Price | 2026 Price | Change |
|------|------------|------------|--------|
| SWPPP Narrative | $1,095 | $1,350 | +$255 (+23%) |
| Silt Fence (Install & Remove) | $4.90/LF | $5.50/LF | +$0.60/LF (+12%) |
| Compost Filter Sock (Install) | $2.75/LF | $2.75/LF | $0 (0%) |
| Inlet Protection | $125/EA | $152/EA | +$27/EA (+22%) |
| SWPPP Sign | $275 | $295 | +$20 (+7%) |
| Spill Kit | $325 | $360 | +$35 (+11%) |
| SWPPP Inspections | $295/EA | $205/EA | -$90/EA (-31%) |
| Mobilization | $450 | $265 | -$185 (-41%) |

**Note**: SWPPP inspection unit price and mobilization have actually DECREASED since 2022. The primary cost escalation argument for our services would be:

1. **Extended duration** - More inspections needed due to project timeline extension (originally Sept 2024, now July 2027+)
2. **Insurance costs** - Any additional insurance premiums during suspension period
3. **Re-inspection costs** - Inspections of existing BMPs before resumption
...
- 22-014 USACE LETTER C-0007 - SUSPENSION OF WORK EXTENSION #3.pdf
- 22-014 USACE LETTER C-0008 - PARTIAL SUSPENSION OF WORK.pdf
...
- Government project - strict documentation requirements
- Work will resume in phases: structural system and new roof first, then original/revised scope
- ASI package will be issued after work resumes for revised building layout pricing
- Failure to respond will result in holding firm to original subcontract requirements

---

## Full Email Timeline (Oct 2022 - Present)

### 2022 - Contract Origination
...
- Site visit planned for swing space area survey
- Contacts provided:
  - Todd Cruz (PM/SSHO): 847-840-9357
  - Ebben Kicklighter (Superintendent): 847-840-5845
...
- Added to inspection master for Derek inspections
...
**November 27, 2024**: PROJECT FORMALLY SUSPENDED
...
- Attached all USACE suspension/resumption letters
...
Cost Escalation Documentation Required:

- [ ] Calculate cost escalation since suspension (Nov 27, 2024)
- [ ] Document extended insurance costs
- [ ] Document any bond premium extensions
- [ ] Document extended general conditions
- [ ] Document any storage costs (warehouse/CONEX)
- [ ] Document re-inspection costs needed
- [ ] Compare original quotes vs current pricing
- [ ] Prepare detailed supporting documentation
- [ ] Submit cost information to Todd Cruz by Feb 13, 2026

### Admin Tasks

- [x] Find Monday item ID (9785900360, Won status, deal close 2022-01-01)
- [x] Find original estimate PDF - Est_09202211_DESERT_SERVICES_1788.pdf (from Oct 2022 email)
- [x] Find original subcontract - 22-014-SA02_SERVICE_AGREEMENT_DESERT_SERVICES.pdf (from Nov 2022 email)
- [x] Extract estimate VALUE from the PDF - **$17,552.00** (34 inspections @ $295 = $10,030 bulk of contract)
- [ ] Update Monday with suspension/resumption status notes
- [x] Review $10,000 change order status - RESOLVED: COR was for contract capacity, no work billed, credit applied to clean up
- [x] Investigate credit memo from June 2025 - RESOLVED: Per Kendra, just accounting cleanup
- [ ] Create/update SharePoint folder under Richard Group

### Upon Resumption (End of Feb 2026)

- [ ] Prepare for SWPPP inspection restart
- [ ] Review revised scope when ASI package issued
- [ ] Submit change order through GC Pay for new scope
- [ ] Confirm new completion timeline (July 2027+)
