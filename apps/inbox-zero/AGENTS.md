...
- Run AI tests: `bun run test-ai`
- Run single test: `bun run test __tests__/test-file.test.ts`
- Run specific AI test: `bun run test-ai ai-categorize-senders`
- Type-check build (skips Prisma migrate): `cd apps/web && bunx next build && cd ../..`
