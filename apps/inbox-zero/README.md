...
> **Prerequisites**: [Docker](https://docs.docker.com/engine/install/), [Node.js](https://nodejs.org/) v22+, and [Bun](https://bun.sh/) v1+
...
bun install
bun run setup                                     # Interactive env setup
cd apps/web && bunx prisma migrate dev && cd ../..
bun dev
```
