...
export function FixWithChat({
  ...
  const selectedRuleName = useMemo(() => {
    ...
    if (selectedRuleId === NONE_RULE_ID) {
      return "None";
    }
          ...
          {data && !showExplanation ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <span className="font-medium text-sm">Selected rule:</span>
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={explanation}
                />
                <p className="mt-1 text-gray-500 text-xs" id="explanation-help">
...
function RuleMismatch({
  ...
  return (
    <div>
      <Label label="Matched:" name="matchedRule" />
      <div className="mt-1">
        {results.length > 0 ? (
