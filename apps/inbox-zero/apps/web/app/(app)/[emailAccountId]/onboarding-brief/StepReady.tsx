...
import { Sparkles, CheckIcon, ExternalLinkIcon } from "lucide-react";
      ...
      <div className="mt-8 flex flex-col items-center">
        <CardBasic className="mt-4 p-6 w-full">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-sm font-semibold text-blue-700">
              Internal mode
            </div>
          </div>
