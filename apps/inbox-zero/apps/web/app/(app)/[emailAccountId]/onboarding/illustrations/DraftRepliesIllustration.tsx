...
export function DraftRepliesIllustration() {
  ...
  return (
    <div className="flex h-[240px] w-full max-w-[360px] flex-col justify-center gap-1.5 sm:w-[400px] sm:max-w-none">
      <motion.div
      ...
      >
        <div className="flex items-center gap-2 px-3 py-2">
          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-pink-100 font-semibold text-[9px] text-pink-600">
            SC
          </div>
        ...
        <div className="px-3 pb-2 text-left text-[10px] text-gray-700 leading-relaxed dark:text-gray-300">
      ...
      <motion.div
        ...
        transition={{ duration: 0.4, ease: [0.25, 0.46, 0.45, 0.94] }}
      >
        <div className="flex items-center gap-1 border-gray-100 border-b px-3 py-1.5 dark:border-gray-700">
        ...
        <div className="px-3 py-2">
          <motion.div
            ...
            className="text-left text-[10px] text-gray-800 leading-relaxed dark:text-gray-200"
            initial={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="mt-1 text-left text-[10px] text-gray-800 leading-relaxed dark:text-gray-200"
            initial={{ opacity: 0 }}
            transition={{ duration: 0.3 }}
          >
            <p>
        ...
        <div
          aria-hidden="true"
          className="flex items-center justify-between border-gray-100 border-t px-2 py-2 dark:border-gray-700"
        >
          <div className="flex items-center gap-1">
            <span className="rounded bg-blue-600 px-2.5 py-0.5 font-medium text-[9px] text-white">
              Send
            </span>
