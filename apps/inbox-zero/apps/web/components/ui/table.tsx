...
>(({ className, ...props }, ref) => (
  <tr
    className={cn(
      "border-border border-b transition-colors hover:bg-slate-100/50 data-[state=selected]:bg-slate-100 dark:data-[state=selected]:bg-slate-800 dark:hover:bg-slate-800/50",
      className
    )}
    ref={ref}
    {...props}
