 ...
 *
 * Usage:
 *   bun apps/web/cli/webhook-jobs.ts list --limit 20
 *   bun apps/web/cli/webhook-jobs.ts list --type dust_permit_payment
 *   bun apps/web/cli/webhook-jobs.ts show 123
 *   bun apps/web/cli/webhook-jobs.ts requeue 123 [--force] [--keep-attempts]
 *   bun apps/web/cli/webhook-jobs.ts clone 123
 *   bun apps/web/cli/webhook-jobs.ts latest dust_permit_payment
 *
 * Notes:
...
function usage(exitCode = 1): never {
  ...
  console.log("");
  console.log(
    "Usage: bun apps/web/cli/webhook-jobs.ts <command> [args] [--flags]"
  );
  console.log("");
  ...
  console.log(
    "  bun apps/web/cli/webhook-jobs.ts list --type dust_permit_payment --limit 10"
  );
  console.log("  bun apps/web/cli/webhook-jobs.ts show 1234");
  console.log("  bun apps/web/cli/webhook-jobs.ts clone 1234");
  console.log("  bun apps/web/cli/webhook-jobs.ts requeue 1234 --force");
