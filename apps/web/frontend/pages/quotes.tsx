...
import { QuotesEmptyActions } from "@/apps/web/frontend/components/quotes/quotes-empty-actions";
import { QuotesHeaderActions } from "@/apps/web/frontend/components/quotes/quotes-header-actions";
import {
  QuotesTable,
