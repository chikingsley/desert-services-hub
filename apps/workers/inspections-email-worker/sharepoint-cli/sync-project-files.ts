 ...
 *
 * Usage:
 *   bun apps/cli-tools/sharepoint-cli/sync-project-files.ts --notion-id=<id>
 *   bun apps/cli-tools/sharepoint-cli/sync-project-files.ts --project-name="Symbiont"
 *   bun apps/cli-tools/sharepoint-cli/sync-project-files.ts --dry-run --notion-id=<id>
 *
...
const attachments = (await db.query(queryStr).all(params)) as AttachmentRow[];
