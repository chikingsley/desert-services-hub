# DAWN WAGNER - COMPREHENSIVE MEETING NOTES

* *Meeting Date:** October 22, 2024
* *Interviewee:** Dawn Wagner
* *Role/Title:** Billing Coordinator - Water Trucks & Street Sweeping
* *Years of Service:** 6 years
* *Service Families:** Water Trucks (WT), Street Sweeping (SW), Pressure Washing, Construction Cleanup
...
Dawn Wagner manages billing operations for Water Trucks, Street Sweeping, Pressure Washing, and Construction Cleanup divisions using an Excel-based scheduling system on SharePoint. She processes 75-150 emails per day from multiple sources including sales, customers, and answering service. Working closely with directors Daniel Vargas (Water Truck) and Kelly Kline (Street Sweeping), Dawn coordinates work intake, scheduling, and billing across both invoice-based and contract billing workflows. Her system uses color-coding to track job status (yellow = scheduled, blue = contract billing, white = completed) and relies on organizing emails into department-specific folders for efficient retrieval. Key challenges include managing high email volume, waiting 1-2 weeks for timesheets to complete billing cycles, and coordinating with multiple stakeholders across different communication preferences.
...
* *Invoice Billing (Standard Jobs):**

1. Wait for work complete documentation from directors
2. Match work complete against schedule
3. Create invoice in QuickBooks
4. Track PO numbers where required
5. Send invoice to customer

* *Contract Billing (Blue-Highlighted Jobs):**

1. Dawn creates invoice in QuickBooks based on work complete
2. Emails Kendra: "Invoice ready for [Customer/Project]"
3. Kendra receives invite to bill in external platform (Textura, GCPAY, Procore, Premiere)
4. Kendra processes payment through platform
...
### 2. Timesheet Lag Creating Billing Delays
...
### 1. Digital Timekeeping & Work Complete System

* *Current Pain:** 1-2 week lag on timesheet/work complete receipt delays billing
...
* *Current Pain:** Excel-based system requires manual updates, no integration, no automation
...
* *Current Pain:** Dawn learns about contract changes late or indirectly
...
* *Current State:** Answering service sends emails, Dawn manually enters into schedule
...
### 5. Automated PO Requirement Flagging

* *Current Pain:** Must remember which customers require POs, risk of missing
...
* *Current Pain:** Different formats from different directors (email vs. picture of handwritten sheet)
...
* *Current Pain:** 75-150 emails daily, manual folder organization
...
## DAWN'S PERSPECTIVE & INSIGHTS

### On Email Volume

"I range from probably 75 to 150 emails a day. So if you tell me to do something, don't keep asking me. I will do it. Don't send me another fucking email. I'll probably walk over."

### On Sales Communication Issues

"So now Since Dawn gave her angry eyes, I'm like, you need to include me... So communication... So now I've got them all under control as far as..."

### On Suntec

"Suntec is very annoying. Just saying."
[Requires separate invoice for every hit with specific PO, frequent rescheduling]

### On Kelly Kline

"He works at home. I've seen him three times. I've worked here for six years. The first five years I only saw him one time. Since Tim has owned it, I've seen him three times. The first time he just came strolling in, I'm like, who's the hell is this homeless person in here?"

### On Her System

"I'm the old school one... It works, you know."

### On Communication Preferences

"Kelly likes texting but as long as I get the communication, I don't care. As long as I get it."

### On Email Organization

"I've got a folder for Kelly, Daniel. Eventually you'll have your own folder. Because it's easier for me to search. I can just go to the department or whoever it is... I just have my own folder so if I gotta know directly, I don't have to search my whole damn email. I just go to that folder and then type what they want."

### On Timesheet Lag

"I'm always a week kind of two weeks behind on timesheets. Like for example, this is week ending the twelfth. So I'm working on this week."

### On Billing Timing

"Street sweeping and water truck I have to wait till the end of the month. Well actually kind of the second week, first second week of the following month."

### On Future Systems

"I don't know if I'm gonna still be using a spreadsheet either. You know?"

### On Contract Confusion

[Regarding Findor/Red Point issue]
"I looked at here I was like well that don't really match Red Point... So then the guy replies like, you know... it's under Findor. So this has all happened this morning."

### On Work Complete Matching

"Anything in yellow, it means it's scheduled. And if it's not hit, I ask Kelly. Kelly Kelly, what's happening? Why didn't we hit this hit?"

### On QuickBooks Documentation

"This is backup for me... You always attach where it's coming from... All the information from this morning if you open it up I attached all the confirmation of what it is and the correct information."
...
Dawn Wagner manages complex billing operations for four service families using manual Excel-based systems while processing 75-150 emails daily from diverse sources. Her organizational skills, folder-based email system, and color-coded scheduling approach enable her to coordinate between directors, sales, customers, and contract billing platforms. However, the system faces scalability challenges as the business grows. The primary opportunities for improvement center on implementing digital timekeeping (BusyBusy), transitioning from Excel to an integrated scheduling and billing platform, standardizing contract communication, and automating PO requirement tracking. The current 1-2 week billing lag could be reduced to 1-2 days with real-time work complete data, significantly improving cash flow. Dawn's deep knowledge of customer requirements, billing workflows, and organizational systems makes her a critical resource, but the manual nature of her current processes creates bottlenecks and limits scalability. Strategic investments in technology and process standardization would unlock significant efficiency gains while maintaining the accuracy and customer service quality Dawn currently delivers.
