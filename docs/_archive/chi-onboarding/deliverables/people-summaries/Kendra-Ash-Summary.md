# KENDRA ASH - COMPREHENSIVE MEETING NOTES

* *Meeting Date:** October 2024
* *Interviewee:** Kendra Ash
* *Role/Title:** Billing & Contract Manager
* *Years of Service:** 17+ years (with company since Mike Lane ownership)
* *Service Families:** SWPPP, Temp Fence, Rentals (Fence, Grates, Backflows, Hoses, Water Ramps, Water Donkeys)
...
Kendra Ash is the central figure in Desert Services' billing, contract management, and accounts receivable operations. With 17+ years at the company, she manages all SWPPP and temp fence billing, contract review and execution, rental equipment tracking, payment processing across multiple platforms (Textura, Procore, GC Pay, Premier), insurance certificate coordination, and change order management. She is the only person who signs contracts and manages contract true-ups. Kendra serves as institutional memory for the company, having worked through the transition from Mike Lane's ownership to Tim's current management. Her role has expanded significantly as the company has grown, creating capacity challenges as she balances billing cycles, contract negotiations, payment platform management, CSIP/OCIP compliance, and support for field operations.
...
## BILLING PROCESSES & WORKFLOWS

### Contract vs. Invoice Billing
...
* *Confirmed Schedule Workflow:**

1. Work completed in field
2. Jason updates "Work Description" in column K
3. Green highlighting removed when work complete added
4. Kendra reviews non-colored rows (no green/pink = needs billing)
5. Yellow = questions/issues to resolve
6. Kendra creates invoice or adds to contract billing
7. Kendra moves to "Billed and Verified" section after billing complete
...
### Rental Master Spreadsheet

* *Location:** Data drive → Customer Rental Master
...
1. Work completed notification from field
2. Enter customer and item information
3. Bill through date updated monthly
4. Sort by bill through date
5. Generate monthly rental invoices
6. Cut and paste completed rentals to "Billed and Verified" tab
...
## CONTRACT INTAKE & MANAGEMENT PROCESS
...
## ESTIMATING & QUICKBOOKS STRUCTURE

### Estimate Storage in QuickBooks
...
### When Change Orders Needed

* *Discovered During Billing:**

1. Work completed exceeds contract amount
2. Work completed not on contract at all
3. Contract items not completed
...
### Best Customer Example: MT Builders
...
### 1. Lack of Project Management Structure
...
### QuickBooks (Primary Billing System)
...
### Historical Context: Mike Lane Ownership
...
## WATER METER & BACKFLOW PROCESS

### When Water Meters Needed
...
3. Create schedule matching contract
4. Input into Textura/Procore/GC Pay/Premier
5. Submit to customer for approval
6. Customer approves schedule
7. Can begin monthly billing
...
1. Work completed throughout month
2. Billing window opens (typically 20th-25th)
3. Kendra reviews confirmed schedule for completed work
4. Verifies against schedule of values
5. Creates invoice in QuickBooks with memo "Not Submit"
6. Adds additional work to same invoice throughout month
7. When billing window opens, submits pay app through platform
8. Updates QuickBooks memo with submission date and platform
9. Platform processes and either approves or rejects
10. If rejected, fix issues and resubmit
11. If approved, wait for payment (typically 60 days)
12. Apply payment when received
...
## KENDRA'S INSIGHTS & PERSPECTIVES

### On Project Management Need

> "Well, so how come 'cause I'm the only one... if there's anything different or wrong I'm the one who must take care of all of it and I'm the one who has to get the customers to respond and get me change orders and get things changed and I don't really have time to follow up."
> "Like by yourself is like how it goes. You have like project coordinators who each have so many jobs. They don't have all of this and all of this... you somebody has to manage all the bodies and the schedules."
> "Even the software we were looking at, they're like, well then your project managers have to get in here and like approve change order requests and do this and do that. I'm like, yeah, no, we don't have any of that. Don't have any of those processes."

### On QuickBooks Limitations

> "QuickBooks just is not really made for this kind of company. It's made for smaller... companies."
> "We definitely need some different software."
> "You can't really adjust anything in there. So the only thing we have are the invoice numbers and then we have whatever in the memo."

### On Contract Process Issues

> "To me it's always a surprise... because I have have no idea what we're doing until I go to bill for it. And then when I go to bill for it, I realize it's something brand new that was never even in the contract. So that's the kind of thing that shouldn't happen."
> "We should know ahead of time that it's not... and that's how we could get the change order request out to them right away and get it change order... it shouldn't just be all of a sudden they want you to bill that month and oh shit I can't because this wasn't even on the contract."

### On Customer Responsiveness

> "Customers don't answer very often... Unless of course they want the job started immediately. But if if the con if we already installed and then we get the contract and I need to get changes on it Then it's really difficult to get because they don't really care."
> "Then they might just ignore me for another four months. So we might have [change orders] sitting there for and that happens all the time. It's very, very often."

### On MT Builders (Best Customer)

> "They're amazing. They always send us a contract. They always are in Textura for SWIP, but everything else, they let us invoice them. And that's how they are on every single job because they have their billing department makes the rules, not the project manager. So that's the one customer. Everyone should run like MT builders. They're awesome."

### On Historical Operations

> "We have never had [tracking] we never had to lock anything. We never had to... like he wouldn't even do any of the crap... Rec reconciliations... He wouldn't do that till like one he'd do one at the end of the year for since January and then he'd be asking us questions. So what happened here in February? Well, I don't freaking know."

### On Current Capacity

> "I don't have time... 'cause of the other part of all the contract stuff that I have to do."
> "Normally I don't have a set schedule of any kind... actually I don't I never do. It's just I just answer I just whatever is an urgent thing that day, I get emails all day long of we need this right now. We need this right now. We need this right now."

### On Growth Challenges

> "Right now it's not you can't really grow... There's there's... well what I see is immediately... there's no way to immediately see the forecast... no way to forecast material wise or people wise on anything."

### On What's Needed

> "If we could get someone smart like you and to find some software that would help... I hope you can figure out because that would be great."
...
> "I just answer I just whatever is an urgent thing that day, I get emails all day long of we need this right now. We need this right now. We need this right now."

### On Billing Complexity

> "I have to do the... schedule values for all the contract work. So I have to put the scheduled values together and then I have to match them up with the scheduled values and then I have to so most of the time we put in more than we're supposed to. So then I have to go back to the customer then and get a change order for the difference."

### On Multiple Platforms

> "I get hundreds and hundreds of them [emails] a month... I have it all go to a separate folder" [regarding Textura]

### On Equipment Tracking

> "How much temp fence do we have right now? How much temp fence do we own?" → "Oh gosh... No... a lot."

### On Remote Work Challenges

> "I have to have that happen all the time because I can't work without QuickBooks. But they can't get it to work outside of logging in and having a desktop down at the office."

### On Contract Delays

> "We started doing work in December of last year... the job actually started [in July]... But now still they haven't set us in a texture... and now I'm not ever gonna be able to update my memo."
...
> "Sometimes again we have lots of jobs with them... it's can be... maybe it should go on the job. I don't know. I just never did it that way before."
> "The estimate a lot of times is named something different because that was what was on the plan. And then when they send out a contract or even in their email, they name it something completely different... And then people look at just the estimate, they don't look at the contract and they name it that and then... other people and no one has any idea what anyone's talking about because they're all different. And we don't even know they're the same job."

### On Industry Standard vs. Reality

> "I mean that is normally how it works so everyone who ever talks to me [says so]... It's like, well, so how come 'cause I'm the only one."

### On Hope for Future

> "If we're all on the same page... We could just do it and pay us for it regardless."
...
Kendra Ash is the linchpin of Desert Services' financial operations, managing an extraordinarily complex web of billing platforms, contract negotiations, payment tracking, and compliance requirements. Her 17+ years of institutional knowledge make her irreplaceable, but also create dangerous single points of failure. The company has outgrown QuickBooks and manual Excel tracking systems, creating inefficiencies and capacity constraints that limit growth.

The biggest opportunities for improvement center on implementing proper project management structure, dedicating resources to contract coordination, investing in construction-specific software, and systematizing processes that currently exist only in Kendra's head. The transition from Mike Lane's cash-based operation to Tim's formalized accounting requirements has created new challenges (locked periods, audits, compliance) without providing new tools to handle increased complexity.

Kendra's willingness to offer training sessions ("you can call me and I can always just have you watch me go through billing") demonstrates both her collaborative nature and the urgent need to document and distribute her knowledge before it becomes a crisis. Her insight that "the software we were looking at, they're like, well then your project managers have to get in here and like approve change order requests... I'm like, yeah, no, we don't have any of that" perfectly captures the gap between industry standards and current operations.
