# RICK HAITAIAN - COMPREHENSIVE MEETING NOTES

* *Meeting Date:** October 22, 2024
* *Interviewee:** Rick Haitaian
* *Role/Title:** Sales Manager
* *Service Families:** All service lines (SWPPP, Water Trucks, Temporary Fencing, Porta Johns, Roll-Offs, Street Sweeping, Construction Cleaning)
* *Years of Service:** Approximately 5 months in current role
...
Rick Haitaian serves as Sales Manager at Desert Services, overseeing the sales process and activities for all service families. Since joining 5 months ago, Rick has implemented fundamental sales improvements including a systematic follow-up process on submitted bids and estimates—a practice that did not exist previously. He actively monitors lead generation sources (particularly Maricopa Dust Permits), tracks sales activities through Monday.com's Last Activity Column, and manages a structured sales team with defined territories. Despite these improvements, Rick identifies significant gaps in the organization including a "loosey goosey" sales process with no standardized handoff procedures, complete absence of inventory tracking for capacity planning, and no formal business planning framework. The company maintains an 18% conversion goal on estimates, though Rick notes this metric may be inflated as the company bids on multiple projects for single opportunities.
...
* *Two Types of Losses Identified:**
...
### New Project Notification Process

* *When Sales Secures a New Project, Message:**

1. **Jared** (Estimating/Operations)
2. **Jayson** (SWPPP Director)
3. **Kendra** (Contract Administration)
...
### Issue #1: Lack of Standardized Sales Process
...
### 1. Formalize Sales-to-Operations Handoff Process

* *Current State:** Ad hoc communication to Jared, Jayson, and Kendra
...
* *Current State:** Tracking two loss types (GC loss vs. competitor loss)
...
1. **Follow-up Process:** Implemented systematic follow-up on all bids
2. **Activity Tracking:** Structured use of Monday.com Last Activity Column
3. **Lead Monitoring:** Proactive monitoring of Maricopa Dust Permits
4. **Lunch and Learns:** Initiated new relationship-building program
5. **Loss Tracking:** Started categorizing reasons for lost bids
...
1. Document current sales process (as-is state)
2. Create standardized handoff checklist
3. Schedule next 6 Lunch and Learn events
4. Implement enhanced loss tracking categories
5. Conduct monthly pipeline review with operations

### For Operations/Leadership

1. Assess inventory tracking system options
2. Designate owner for business planning framework
3. Schedule sales process improvement workshop
4. Review and approve territory assignments
5. Establish KPIs for sales effectiveness

### For Cross-Functional Collaboration

1. Define required information for each service family handoff
2. Create RACI matrix for sales-to-operations transition
3. Establish regular sales-operations sync meeting (weekly or biweekly)
4. Pilot new handoff process with next major project
...
Rick Haitaian has made meaningful improvements to Desert Services' sales function in his first 5 months, particularly implementing a follow-up process where none existed. However, significant opportunities remain to formalize the sales process, implement inventory and capacity planning systems, and create a business planning framework. The company's 18% conversion goal, combined with Rick's assessment that losses are not primarily due to pricing, suggests opportunities to improve through better process, planning, and relationship management. The recent launch of Lunch and Learn events, proactive monitoring of lead sources, and structured territory assignments provide a foundation for continued growth. The most critical next steps are formalizing the sales-to-operations handoff process and implementing an inventory tracking system to prevent margin erosion on large material-intensive projects like the 10,000-foot fence example.
