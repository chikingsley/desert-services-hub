...
Application fees are based on the number of acres being disturbed during construction activities. Annual fees are invoiced each year the permit is active, during the anniversary month of the NOI issuance.

*More information about fees | View*

### Will there be annual fees for the 2025 CGP?

Yes. Annual fees are billed in the NOI anniversary month and continue until the permittee submits a Notice of Termination (NOT) and ADEQ approves the NOT.

### Do I need to pay the renewal fee invoice I received prior to the Aug. 28, 2025 expiration date and then still file a new NOI between Aug. 29, 2025 and Oct. 28, 2025, and pay an additional fee if my construction activities will continue beyond Oct. 29?

Yes. The 2025 CGP is a new permit, requiring a new NOI and permit fee. All AZPDES permits have standard permit conditions. One such condition is the Duty to Reapply/Continuation of the Expired General Permit which states: upon reissuance of the general permit, the operator shall file an electronic Notice of Intent through myDEQ within the timeframe specified in the new general permit, and shall obtain new written authorization to discharge from the Director.

### Can payment be made for multiple NOIs or does each one need to be paid separately?

Each NOI needs to be paid individually.
...
### Will we select New NOI in myDEQ, even if we were covered under the previous permit and are essentially transferring coverage to the 2025 CGP?

Yes. From your myDEQ Dashboard, click the myAPPLICATIONS tab. At the top right, click **Get New**. You can then enter your new NOI under the 2025 CGP in myDEQ.

## Stormwater Discharge

### When asked, “Where does stormwater discharge from your site?”, what happens if you choose “I’m not sure”?

The myDEQ system will provide additional questions to determine whether you have applicable discharges.
...
For sites without an official mailing address, you can select the latitude/longitude from a map. Typically, for linear projects, select a point on the map in the middle of the project site and provide additional location information in the Driving Directions box. If there are no from-to streets, using mileposts is acceptable.
...
When you reach this page in myDEQ, you will be provided a spreadsheet template to download. Fill out the latitude/longitude and provide a name/number for each outfall. Upload the completed spreadsheet in myDEQ.
...
The myDEQ system is programmed to set up an e-DMR for all sites within 1/4 mile of an impaired or OAW. Even though you will not have to analytically monitor for impairments, you are still required to submit a No Data DMR as per the requirements in Section 7 of the permit.
...
This means construction activities, equipment, products, waste products, materials, etc., that are exposed to stormwater (rain, snow, snowmelt, or runoff) and can demonstrate that they do not discharge stormwater, do not need coverage under ADEQ’s CGP and may qualify for the optional NDC.
...
Once certified, myDEQ will issue a No Discharge Certificate electronically via email to the applicant.

## Other

### If we had a permit prior to Aug. 29, 2025 (before the 2020 CGP expired) and we are not going to perform construction activities on that site, do we still need a 2025 CGP?

No. If you are not performing construction activities or if your construction activities are complete and final stabilization is in place, you do not need an NOI under the 2025 CGP.

### Where is the expiration date for each NOI?

The 2025 CGP expires on Aug. 28, 2030, which is listed upon issuance. NOIs are active until a notice of termination (NOT) has been submitted and ADEQ approves the NOT, or until Aug. 28, 2030, whichever occurs first.
...
## Referenced Documents (Summarized)

### EPA Fact Sheet 3.1 — Construction Rainfall Erosivity Waiver

**What it is:** The Stormwater Phase II rule allows permitting authorities to waive NPDES requirements for small construction sites if the rainfall erosivity factor (R factor) for the construction period is less than 5. Permitting authorities may choose not to allow waivers.

**Key limits and conditions:**
- Waiver is not available for sites disturbing more than 5 acres.
- State or Tribal authorities can set thresholds lower than 5, suspend the waiver in sensitive watersheds or seasons, or disallow it entirely.
- The operator must certify that the construction period occurs when the R factor is less than 5. If the project end date changes, the R factor must be recalculated and the certification resubmitted or permit coverage obtained.

**How to estimate the R factor (short method):**
- Estimate construction start date (first soil disturbance) and end date (final stabilization).
- Find the Erosivity Index (EI) Zone for your location.
- Use the EI table to get percent EI for the start and end dates, then subtract to get the project %EI.
- Find the annual isoerodent (R) value for your location.
- Multiply project %EI by the annual R value to get the project R factor.

**Alternative method:** The USDA RUSLE2 tool can be used to calculate R. Local USDA Service Centers can assist.

### myDEQ User Roles & Responsibilities

**Responsible Corporate Officer (RCO):** Main account holder with legal authority to bind the organization. Certifies the Subscriber/Signature Agreement, handles initial account setup, and adds DROs.

**Delegated Responsible Officer (DRO):** Authorized by the RCO via notarized Signature Agreement. Oversees myDEQ account activities for the organization.

**Submitter:** Authorized via notarized Signature Agreement. Can submit compliance reports and modify permit information as allowed by the RCO/DRO.

**Data Entry:** Prepares compliance report data but cannot submit data to ADEQ.
