      ...
      >
        <div className="FreetextHighlight__container" style={containerStyle}>
          <div className="FreetextHighlight__toolbar">
            <div
              className="FreetextHighlight__drag-handle"
              title="Drag to move"
            >
          ...
          {isStylePanelOpen && (
            ...
            >
              <div className="FreetextHighlight__style-row">
                <label htmlFor="freetext-bg-color">Background</label>
              ...
              <div className="FreetextHighlight__style-row">
                <label htmlFor="freetext-text-color">Text Color</label>
                <div className="FreetextHighlight__color-options">
                  <div className="FreetextHighlight__color-presets">
              ...
              <div className="FreetextHighlight__style-row">
                <label htmlFor="freetext-font-size">Font Size</label>
                <select
                  id="freetext-font-size"
                  onChange={(e) => {
              ...
              <div className="FreetextHighlight__style-row">
                <label htmlFor="freetext-font">Font</label>
                <select
                  id="freetext-font"
                  onChange={(e) => {
