...
bun services/contract/workflow/collect.ts add ./packages/contracts/projects/ground-truth/project-1073-sun-health-rgs ./downloads/contract.pdf

# List documents in a folder
bun services/contract/workflow/collect.ts list ./packages/contracts/projects/ground-truth/project-1073-sun-health-rgs
```css
...
bun services/contract/workflow/extract.ts ocr ./packages/contracts/projects/ground-truth/project-1073-sun-health-rgs/contract.pdf
...
bun services/contract/workflow/reconcile.ts validate ./packages/contracts/projects/ground-truth/project-1073-sun-health-rgs
