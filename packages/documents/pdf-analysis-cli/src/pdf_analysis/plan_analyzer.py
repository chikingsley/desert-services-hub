...
if __name__ == "__main__":
    # Example usage
    print("Plan Analysis Utility with Gemini 3 Flash Agentic Vision")
    print("=" * 60)
    print("\nUsage:")
    print("  from plan_analyzer import PlanAnalyzer, quick_analyze")
    print("  ")
    print("  # Quick analysis")
    print("  result = quick_analyze('path/to/plan.pdf', plan_type='swppp')")
    print("  ")
    print("  # Detailed inspection")
    print("  analyzer = PlanAnalyzer()")
    print("  inspection = analyzer.detailed_inspection(")
    print("      'path/to/plan.jpg',")
    print("      'Count all sediment basins and verify dimensions'")
    print("  )")
