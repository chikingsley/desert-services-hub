 ...
 *
 * Usage:
 *   bun packages/email/cli/bc-bids-sync.ts              # Incremental sync
 *   bun packages/email/cli/bc-bids-sync.ts --full       # Full re-sync
 *   bun packages/email/cli/bc-bids-sync.ts --limit=100  # Limit emails
 */
