 ...
 *   bun packages/email/cli/immutable-ids.ts --mailbox contracts@desertservices.net,denise@desertservices.net
 *   bun packages/email/cli/immutable-ids.ts --batch-size 500 --max-rows 10000
 *   bun packages/email/cli/immutable-ids.ts --dry-run
 */
...
export async function runImmutableIds(args: string[] = []): Promise<void> {
