...
import { catalogCategories } from "@/packages/estimates/catalog/definitions/categories";
import { takeoffBundlesData } from "@/packages/estimates/catalog/definitions/takeoff-bundles";
import type {
  Catalog,
  CatalogCategory,
  CatalogItem,
