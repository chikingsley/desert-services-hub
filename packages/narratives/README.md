...
- `packages/narratives/data/intake/eva-to-jayson/source-packets/deterministic_validation.json`
- `packages/narratives/data/intake/eva-to-jayson/source-packets/deterministic_alignment.csv`
