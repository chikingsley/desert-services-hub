...
import { SWPPP_MASTER_ITEM_ID, WORKSHEETS } from "@sharepoint/swppp/config";
import { parseWorksheet } from "@sharepoint/swppp/parser";
...
export class SwpppMasterClient {
  ...
  async getProjects(worksheet: WorksheetName): Promise<SwpppProject[]> {
    ...
    return parseWorksheet(worksheet, data);
  }
