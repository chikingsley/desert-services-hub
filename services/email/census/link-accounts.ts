 ...
 * 4. Conversation propagation → if sibling is linked, link this one
 *
...
export function linkEmailsToAccounts(): LinkStats {
  ...
  try {
    ...
    // ========================================
    // Signal 5: Conversation propagation
    // ========================================
    console.log("Signal 4: Propagating via conversation threads...");
...
// CLI entry point
if (import.meta.main) {
  // First, clear existing account links to start fresh
  console.log("Clearing existing account links...");
