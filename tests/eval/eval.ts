 ...
 *
 * Usage:
 *   bun run tests/eval/eval.ts                     # run default (token-overlap) strategy
 *   bun run tests/eval/eval.ts --strategy fts       # run FTS strategy
 *   bun run tests/eval/eval.ts --strategy fts+rerank
 *   bun run tests/eval/eval.ts --strategy dossier+llm
 *
